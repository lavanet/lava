...
lavad server 127.0.0.1 2231 $OSMO_REST COS3 rest --from servicer1 --log_level debug &
lavad server 127.0.0.1 2232 $OSMO_REST COS3 rest --from servicer2 --log_level debug &
lavad server 127.0.0.1 2233 $OSMO_REST COS3 rest --from servicer3 --log_level debug &
lavad server 127.0.0.1 2241 $OSMO_RPC COS3 tendermintrpc --from servicer1 --log_level debug &
lavad server 127.0.0.1 2242 $OSMO_RPC COS3 tendermintrpc --from servicer2 --log_level debug &
lavad server 127.0.0.1 2243 $OSMO_RPC COS3 tendermintrpc --from servicer3 --log_level debug 
echo " ::: providers done! :::"

...
# SINGLE MOCK PROXY
lavad server 127.0.0.1 2221 http://0.0.0.0:$MOCK_PORT/eth/ ETH1 jsonrpc --from servicer1 --log_level debug &
lavad server 127.0.0.1 2222 http://0.0.0.0:$MOCK_PORT/eth/ ETH1 jsonrpc --from servicer2 --log_level debug &
lavad server 127.0.0.1 2223 http://0.0.0.0:$MOCK_PORT/eth/ ETH1 jsonrpc --from servicer3 --log_level debug &
lavad server 127.0.0.1 2224 http://0.0.0.0:$MOCK_PORT/eth/ ETH1 jsonrpc --from servicer4 --log_level debug &
lavad server 127.0.0.1 2225 http://0.0.0.0:$MOCK_PORT/eth/ ETH1 jsonrpc --from servicer5 --log_level debug &

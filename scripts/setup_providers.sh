...
# SOLANA providers
screen -d -m -S solana_providers bash -c "source ~/.bashrc; lavad server 127.0.0.1 6510 $SOLANA_RPC SOLANA jsonrpc $EXTRA_PROVIDER_FLAGS --geolocation 1 --log_level debug --from servicer1 2>&1 | tee $LOGS_DIR/SOLANA_6510.log"

...
screen -S portals -X screen -t win1 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3334 COS3 rest --from user2 2>&1 | tee $LOGS_DIR/PORTAL_3334.log"
screen -S portals -X screen -t win2 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3335 COS3 tendermintrpc --from user2 2>&1 | tee $LOGS_DIR/PORTAL_3335.log"
screen -S portals -X screen -t win3 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3336 FTM250 jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3336.log"
screen -S portals -X screen -t win4 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3337 COS4 rest --from user2 2>&1 | tee $LOGS_DIR/PORTAL_3337.log"
screen -S portals -X screen -t win5 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3338 COS4 tendermintrpc --from user2 2>&1 | tee $LOGS_DIR/PORTAL_3338.log"
...
screen -S portals -X screen -t win7 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3340 LAV1 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3340.log"
screen -S portals -X screen -t win8 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3341 LAV1 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3341.log"
screen -S portals -X screen -t win9 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3343 COS5 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3340.log"
screen -S portals -X screen -t win10 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3344 COS5 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3341.log"
screen -S portals -X screen -t win11 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3342 CELO jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3342.log"
...
screen -S portals -X screen -t win13 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3343 ALFAJORES jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3343.log"
screen -S portals -X screen -t win14 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3344 ARB1 jsonrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3344.log"
screen -S portals -X screen -t win15 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3345 STRK jsonrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3345.log"
screen -S portals -X screen -t win16 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3346 APT1 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3346.log"
screen -S portals -X screen -t win17 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3343 JUN1 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3343.log"
screen -S portals -X screen -t win18 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3344 JUN1 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3344.log"
screen -S portals -X screen -t win19 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3347 POLYGON1 jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3347.log"

...
screen -S portals -X screen -t win25 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3344 COS5 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3341.log"
screen -S portals -X screen -t win24 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3342 CELO jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3342.log"
...
screen -S portals -X screen -t win23 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3344 JUN1 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3344.log"
screen -S portals -X screen -t win22 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3347 POLYGON1 jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3347.log"

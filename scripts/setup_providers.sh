...
screen -S cos5_providers -X screen -t win3 -X zsh -c "source ~/.zshrc; lavad server 127.0.0.1 2344 $GAIA_RPC COS5 tendermintrpc --from servicer1 2>&1 | tee $LOGS_DIR/COS5_2341.log"
...
# Setup Portals
screen -d -m -S portals zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3333 ETH1 jsonrpc --from user1 2>&1 | tee $LOGS_DIR/PORTAL_ETH_3333.log" && sleep 0.25
screen -S portals -X screen -t win1  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3334 COS3 rest --from user2 2>&1 | tee $LOGS_DIR/PORTAL_COS3_3334.log"
screen -S portals -X screen -t win2  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3335 COS3 tendermintrpc --from user2 2>&1 | tee $LOGS_DIR/PORTAL_COS3_3335.log"
screen -S portals -X screen -t win3  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3336 FTM250 jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_FTM250_3336.log"
screen -S portals -X screen -t win4  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3337 COS4 rest --from user2 2>&1 | tee $LOGS_DIR/PORTAL_COS4_3337.log"
screen -S portals -X screen -t win5  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3338 COS4 tendermintrpc --from user2 2>&1 | tee $LOGS_DIR/PORTAL_COS4_3338.log"
screen -S portals -X screen -t win6  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3339 GTH1 jsonrpc --from user1 2>&1 | tee $LOGS_DIR/PORTAL_3339.log"
screen -S portals -X screen -t win7  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3340 LAV1 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_LAV1_3340.log"
screen -S portals -X screen -t win8  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3341 LAV1 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_LAV1_3341.log"
screen -S portals -X screen -t win12 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3342 CELO jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3342.log"
screen -S portals -X screen -t win9  -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3343 COS5 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3343.log"
screen -S portals -X screen -t win10 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3344 COS5 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3344.log"
screen -S portals -X screen -t win13 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3345 ALFAJORES jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3345.log"
screen -S portals -X screen -t win14 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3346 ARB1 jsonrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3346.log"
screen -S portals -X screen -t win15 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3347 STRK jsonrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3347.log"
screen -S portals -X screen -t win16 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3348 APT1 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3348.log"
screen -S portals -X screen -t win17 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3349 JUN1 rest --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3349.log"
screen -S portals -X screen -t win18 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3350 JUN1 tendermintrpc --from user4 2>&1 | tee $LOGS_DIR/PORTAL_3350.log"
screen -S portals -X screen -t win19 -X zsh -c "source ~/.zshrc; lavad portal_server 127.0.0.1 3351 POLYGON1 jsonrpc --from user3 2>&1 | tee $LOGS_DIR/PORTAL_3351.log"

...
$PROVIDER1_LISTENER SOLANA jsonrpc '$SOLANA_RPC,$SOLANA_WS' --geolocation 1 --log_level debug --from servicer1 2>&1 | tee $LOGS_DIR/PROVIDER1.log" && sleep 0.25

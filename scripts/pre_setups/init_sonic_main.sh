...
wait_next_block
lavad tx pairing stake-provider "SONIC" $PROVIDERSTAKE "$PROVIDER1_LISTENER,1" 1 $(operator_address) -y --from servicer1 --provider-moniker "dummyMoniker" --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE

sleep_until_next_epoch
wait_next_block

screen -d -m -S provider1 bash -c "source ~/.bashrc; lavap rpcprovider \
$PROVIDER1_LISTENER SONIC jsonrpc 'https://rpc.soniclabs.com/,wss://sonic-rpc.publicnode.com/' \

...
$EXTRA_PROVIDER_FLAGS --geolocation 1 --log_level debug --from servicer1 --cache-be 127.0.0.1:5555 2>&1 | tee $LOGS_DIR/PROVIDER1.log" && sleep 0.25
...
$EXTRA_PORTAL_FLAGS --geolocation 1 --log_level debug --from user1 --cache-be 127.0.0.1:5555 2>&1 | tee $LOGS_DIR/CONSUMERS.log" && sleep 0.25

...
# ============================================================================
# SLOW PROVIDER TEST CONFIGURATION
# ============================================================================
# Provider 3 will be SLOW (500ms artificial delay)
# This tests the weighted random selection algorithm
# ============================================================================

SLOW_PROVIDER_DELAY_MS=500  # 500ms delay for Provider 3

echo "=============================================="
echo "[SLOW PROVIDER TEST] Provider 3 will have ${SLOW_PROVIDER_DELAY_MS}ms artificial delay"
echo "=============================================="

# Provider 1 - FAST (normal)
...
# Provider 3 - SLOW (with artificial delay flag)
...
$EXTRA_PROVIDER_FLAGS --geolocation 1 --log_level debug --from servicer3 --chain-id lava --metrics-listen-address \":7746\" --artificial-delay ${SLOW_PROVIDER_DELAY_MS}ms 2>&1 | tee $LOGS_DIR/PROVIDER3.log" && sleep 0.25
...
echo ""
echo "=============================================="
echo "[SLOW PROVIDER TEST] Setup Complete"
echo "=============================================="
echo "Provider 1 (FAST): $PROVIDER1_LISTENER - metrics :7766"
echo "Provider 2 (FAST): $PROVIDER2_LISTENER - metrics :7756"
echo "Provider 3 (SLOW): $PROVIDER3_LISTENER - metrics :7746 - ${SLOW_PROVIDER_DELAY_MS}ms delay"
echo ""
echo "Consumer: 127.0.0.1:3360 (rest), 3361 (tendermint), 3362 (grpc)"
echo ""
echo "Expected behavior with Weighted Random Selection:"
echo "  - Provider 3 should be selected LESS frequently due to higher latency"
echo "  - Providers 1 & 2 should receive MORE traffic"
echo ""
echo "To verify, watch the logs:"
echo "  tail -f $LOGS_DIR/CONSUMERS.log | grep -E 'selected|latency|score'"
echo ""
echo "Or check metrics:"
echo "  curl localhost:7766/metrics | grep relay"
echo "  curl localhost:7756/metrics | grep relay"
echo "  curl localhost:7746/metrics | grep relay"
echo "=============================================="

...
lavad tx gov submit-proposal spec-add ./cookbook/sorted_specs/0/spec_add_ethereum.json,./cookbook/sorted_specs/1/spec_add_arbitrum.json -y --from alice --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE

...
$PROVIDER1_LISTENER LAV1 rest http://0.0.0.0:1317 \
$PROVIDER1_LISTENER LAV1 tendermintrpc http://0.0.0.0:26657,ws://0.0.0.0:26657/websocket \
$PROVIDER1_LISTENER LAV1 grpc 0.0.0.0:9090 \
...
$EXTRA_PORTAL_FLAGS --geolocation 1 --log_level trace --from user1 --chain-id lava --add-api-method-metrics  --allow-insecure-provider-dialing --metrics-listen-address ":7780" 2>&1 | tee $LOGS_DIR/CONSUMERS.log" && sleep 0.25

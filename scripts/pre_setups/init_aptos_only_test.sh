...
$EXTRA_PORTAL_FLAGS --geolocation 1 --log_level debug --from user1 --allow-insecure-provider-dialing --allow-providers-with-protected-ips --chain-id lava 2>&1 | tee $LOGS_DIR/CONSUMERS.log" && sleep 0.25

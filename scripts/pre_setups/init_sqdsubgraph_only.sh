...
lavad tx gov submit-legacy-proposal spec-add ./specs/mainnet-1/specs/sqdsubgraph.json --lava-dev-test -y --from alice --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE &
wait_next_block
wait_next_block

...
specs="specs/mainnet-1/specs/ibc.json,specs/mainnet-1/specs/cosmoswasm.json,specs/mainnet-1/specs/tendermint.json,specs/mainnet-1/specs/cosmossdk.json,specs/testnet-2/specs/lava.json,specs/testnet-2/specs/polkadot_asset_hub.json"
...
wait_next_block
lavad tx pairing stake-provider "POLKADOTASSETHUB" $PROVIDERSTAKE "$PROVIDER1_LISTENER,1" 1 $(operator_address) -y --from servicer1 --provider-moniker "dummyMoniker"  --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE

sleep_until_next_epoch

screen -d -m -S provider1 bash -c "source ~/.bashrc; lavap rpcprovider \
$PROVIDER1_LISTENER POLKADOTASSETHUB jsonrpc 'https://polkadot-asset-hub-rpc.polkadot.io,wss://polkadot-asset-hub-rpc.polkadot.io' \

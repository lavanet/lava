...
lavad tx pairing stake-client "GTH" 200000ulava 1 -y --from user1
...
#Goerli providers
lavad tx pairing stake-provider "GTH" 2010ulava "127.0.0.1:2121,jsonrpc,1" 1 -y --from servicer1
lavad tx pairing stake-provider "GTH" 2000ulava "127.0.0.1:2122,jsonrpc,1" 1 -y --from servicer2
lavad tx pairing stake-provider "GTH" 2050ulava "127.0.0.1:2123,jsonrpc,1" 1 -y --from servicer3
lavad tx pairing stake-provider "GTH" 2020ulava "127.0.0.1:2124,jsonrpc,1" 1 -y --from servicer4
lavad tx pairing stake-provider "GTH" 2030ulava "127.0.0.1:2125,jsonrpc,1" 1 -y --from servicer5

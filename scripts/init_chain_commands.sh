...
# MANTLE
CHAINS="ETH1,GTH1,OSMO,FTM250,CELO,LAV1,OSMOT,ALFAJORES,ARB1,ARBN,APT1,STRK,JUN1,COSHUB,POLYGON1,EVMOS,OPTM,BASET,CANTO,SUIT,SOLANA,BSC,AXELAR,AVAX,FVM"

...
sleep 4
lavad tx gov submit-proposal spec-add ./cookbook/spec_add_canto.json -y --from alice --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
#Goerli providers
lavad tx pairing stake-provider "GTH1" $PROVIDERSTAKE "127.0.0.1:2221,jsonrpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
# Fantom providers
lavad tx pairing stake-provider "FTM250" $PROVIDERSTAKE "127.0.0.1:2221,jsonrpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
# Celo providers
lavad tx pairing stake-provider "CELO" $PROVIDERSTAKE "127.0.0.1:2221,jsonrpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
lavad tx pairing stake-provider "ALFAJORES" $PROVIDERSTAKE "127.0.0.1:2221,jsonrpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
lavad tx pairing stake-provider "ARB1" $PROVIDERSTAKE "127.0.0.1:2221,jsonrpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
lavad tx pairing stake-provider "APT1" $PROVIDERSTAKE "127.0.0.1:2221,rest,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
lavad tx pairing stake-provider "STRK" $PROVIDERSTAKE "127.0.0.1:2221,jsonrpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
# Polygon Providers
lavad tx pairing stake-provider "POLYGON1" $PROVIDERSTAKE "127.0.0.1:2221,jsonrpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
# Osmosis providers
lavad tx pairing stake-provider "COS3" $PROVIDERSTAKE "127.0.0.1:2221,tendermintrpc,1 127.0.0.1:2221,rest,1 127.0.0.1:2221,grpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
# Lava Providers
lavad tx pairing stake-provider "LAV1" $PROVIDERSTAKE "127.0.0.1:2221,tendermintrpc,1 127.0.0.1:2221,rest,1 127.0.0.1:2221,grpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
# Juno providers
lavad tx pairing stake-provider "JUN1" $PROVIDERSTAKE "127.0.0.1:2221,tendermintrpc,1 127.0.0.1:2221,rest,1 127.0.0.1:2221,grpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
lavad tx pairing stake-provider "COS4" $PROVIDERSTAKE "127.0.0.1:2221,tendermintrpc,1 127.0.0.1:2221,rest,1 127.0.0.1:2221,grpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
...
# Cosmoshub Providers
lavad tx pairing stake-provider "COS5" $PROVIDERSTAKE "127.0.0.1:2221,tendermintrpc,1 127.0.0.1:2221,rest,1 127.0.0.1:2221,grpc,1" 1 -y --from servicer1 --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE

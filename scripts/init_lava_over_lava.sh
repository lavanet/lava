...
lavad tx gov submit-proposal spec-add ./cookbook/sorted_specs/3/spec_add_cosmoshub.json,./cookbook/sorted_specs/0/spec_add_ethereum.json --from alice -y --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
lavad tx gov vote 1 yes -y --from alice --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE
sleep 3 
lavad tx gov submit-proposal spec-add ./cookbook/sorted_specs/3/spec_add_lava.json --from alice -y --gas-adjustment "1.5" --gas "auto" --gas-prices $GASPRICE

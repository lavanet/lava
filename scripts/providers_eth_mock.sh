...
# go run relayer/cmd/relayer/main.go server 127.0.0.1 2231 http://$OSMO_HOST/rest/ COS3 rest --from servicer1 &
# go run relayer/cmd/relayer/main.go server 127.0.0.1 2232 http://$OSMO_HOST/rest/ COS3 rest --from servicer2 &
# go run relayer/cmd/relayer/main.go server 127.0.0.1 2233 http://$OSMO_HOST/rest/ COS3 rest --from servicer3 &

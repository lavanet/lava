...
const baseSpecAddProposal: object = { title: "", description: "" };

export const SpecAddProposal = {
  encode(message: SpecAddProposal, writer: Writer = Writer.create()): Writer {
    if (message.title !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): SpecAddProposal {
    ...
    const message = { ...baseSpecAddProposal } as SpecAddProposal;
    message.specs = [];

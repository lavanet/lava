...
| ~~3301~~ | ~~`CHAIN_SOLANA_SLOT_SKIPPED`~~ | ~~Solana slot was skipped~~ | — | Removed — superseded by `CHAIN_SOLANA_LEDGER_JUMP` (3303); was dead code, never referenced |
...
| 3344 | `CHAIN_BITCOIN_INSUFFICIENT_FUNDS` | UTXO coin selection failed (-6 / RPC_WALLET_INSUFFICIENT_FUNDS) | No | Bitcoin/UTXO |

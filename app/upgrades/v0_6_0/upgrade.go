...
var Upgrade = upgrades.Upgrade{
	...
	StoreUpgrades:        store.StoreUpgrades{Added: []string{PackagesModuleName}}, // StoreUpgrades has 3 fields: Added/Renamed/Deleted any module that fits these description should be added in the way below
}

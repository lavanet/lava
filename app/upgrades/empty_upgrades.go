...
var Upgrade_0_6_0 = Upgrade{
	...
	StoreUpgrades: store.StoreUpgrades{Added: []string{"packages"}}, // StoreUpgrades has 3 fields: Added/Renamed/Deleted any module that fits these description should be added in the way below
}

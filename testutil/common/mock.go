...
func CreateMockSpec() spectypes.Spec {
	...
	spec.ApiCollections = []*spectypes.ApiCollection{{Enabled: true, CollectionData: spectypes.CollectionData{ApiInterface: "stub", Type: "GET"}, Apis: []*spectypes.Api{{Name: specName + "API", ComputeUnits: 100, Enabled: true, Category: spectypes.SpecCategory{Deterministic: true}}}}}
	spec.BlockDistanceForFinalizedData = 0
	spec.Shares = 1
	return spec
}

...
func InitAllKeepers(t testing.TB) (*Servers, *Keepers, context.Context) {
	...
	ks.Projects = *projectskeeper.NewKeeper(cdc, projectsStoreKey, projectsMemStoreKey, projectsparamsSubspace, &ks.BankKeeper, ks.AccountKeeper, ks.Spec, ks.Plans, ks.Epochstorage)

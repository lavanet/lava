...
func (k mockAccountKeeper) NewAccountWithAddress(ctx sdk.Context, accAddress sdk.AccAddress) types.AccountI {
	return nil
}
...
func (k mockAccountKeeper) SetAccount(ctx sdk.Context, acc types.AccountI) {
}

...
func makeRelayError(err error, lavaErr *common.LavaError, stake int64, reputation string) RelayError {
	return RelayError{
		...
		ProviderInfo: common.ProviderInfo{
			ProviderStake:             github_com_cosmos_cosmos_sdk_types.NewInt64Coin("ulava", stake),
			ProviderReputationSummary: github_com_cosmos_cosmos_sdk_types.MustNewDecFromStr(reputation),

...
func TestConsumerStateMachineHappyFlow(t *testing.T) {
	t.Run("happy", func(t *testing.T) {
		...
		relayProcessor := relaycore.NewRelayProcessor(ctx, common.DefaultQuorumParams, consistency, nil, relaycoretest.RelayProcessorMetrics, relaycoretest.RelayProcessorMetrics, relaycoretest.RelayRetriesManagerInstance, NewSmartRouterRelayStateMachine(ctx, usedProviders, &SmartRouterRelaySenderMock{retValue: nil}, protocolMessage, nil, false, relaycoretest.RelayProcessorMetrics), nil)
...
func TestConsumerStateMachineExhaustRetries(t *testing.T) {
	t.Run("retries", func(t *testing.T) {
		...
		consistency := relaycore.NewConsistency(specId)
		usedProviders := lavasession.NewUsedProviders(nil)
		relayProcessor := relaycore.NewRelayProcessor(ctx, common.DefaultQuorumParams, consistency, nil, relaycoretest.RelayProcessorMetrics, relaycoretest.RelayProcessorMetrics, relaycoretest.RelayRetriesManagerInstance, NewSmartRouterRelayStateMachine(ctx, usedProviders, &SmartRouterRelaySenderMock{retValue: nil, tickerValue: 10 * time.Second}, protocolMessage, nil, false, relaycoretest.RelayProcessorMetrics), nil)
...
func TestProcessingContextTimeoutEnforcement(t *testing.T) {
	t.Run("NoRetriesAfterTimeout", func(t *testing.T) {
		...
		relayProcessor := relaycore.NewRelayProcessor(ctx, common.DefaultQuorumParams, consistency, nil, relaycoretest.RelayProcessorMetrics, relaycoretest.RelayProcessorMetrics, relaycoretest.RelayRetriesManagerInstance, NewSmartRouterRelayStateMachine(ctx, usedProviders, mockSender, protocolMessage, nil, false, relaycoretest.RelayProcessorMetrics), nil)

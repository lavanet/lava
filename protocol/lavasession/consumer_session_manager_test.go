...
func CreateConsumerSessionManager() *ConsumerSessionManager {
	...
	return NewConsumerSessionManager(context.Background(), &RPCEndpoint{"stub", "stub", "stub", false, "/", 0}, provideroptimizer.NewProviderOptimizer(provideroptimizer.STRATEGY_BALANCED, 0, baseLatency, 1, nil, nil), nil, nil, "lava@test", NewActiveSubscriptionProvidersStorage())
}

...
func TestWantedBlockData(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "only one saved block range 1", earliestBlock: 1000, latestBlock: 1000, fromBlock: 1000, toBlock: 1001, specificBlock: spectypes.NOT_APPLICABLE, valid: true, expectedElements: 1},
		{name: "only one saved block overlap", earliestBlock: 1000, latestBlock: 1000, fromBlock: 1000, toBlock: 1001, specificBlock: 1000, valid: true, expectedElements: 1},
		{name: "only one saved block specific from N/A", earliestBlock: 1000, latestBlock: 1000, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: 1000, valid: true, expectedElements: 1},
		...
		{name: "latest only one saved block specific from N/A", earliestBlock: 1000, latestBlock: 1000, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: spectypes.LATEST_BLOCK, valid: true, expectedElements: 1},
		...
		{name: "ten saved blocks range 1", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1001, specificBlock: spectypes.NOT_APPLICABLE, valid: true, expectedElements: 1},
		{name: "ten saved blocks overlap", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1001, specificBlock: 1000, valid: true, expectedElements: 1},
		{name: "ten saved blocks specific from N/A", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: 1000, valid: true, expectedElements: 1},
		...
		{name: "latest ten saved blocks specific from N/A", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: spectypes.LATEST_BLOCK, valid: true, expectedElements: 1},
		...
		{name: "ten saved blocks range 5", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1005, specificBlock: spectypes.NOT_APPLICABLE, valid: true, expectedElements: 5},
		{name: "ten saved blocks range 5 the end of the list", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1005, toBlock: 1010, specificBlock: spectypes.NOT_APPLICABLE, valid: true, expectedElements: 5},
		{name: "ten saved blocks range 5 overlap", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1005, specificBlock: 1003, valid: true, expectedElements: 5},
		{name: "ten saved blocks range 5 w specific next", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1005, specificBlock: 1006, valid: true, expectedElements: 6},
		{name: "ten saved blocks range 5 w specific", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1005, specificBlock: 1007, valid: true, expectedElements: 6},
		{name: "ten saved blocks range 5 w specific before", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1002, toBlock: 1007, specificBlock: 1000, valid: true, expectedElements: 6},
		{name: "ten saved blocks range 5 w specific prev", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1002, toBlock: 1007, specificBlock: 1001, valid: true, expectedElements: 6},
		{name: "ten saved blocks range 10", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1010, specificBlock: spectypes.NOT_APPLICABLE, valid: true, expectedElements: 10},

		{name: "latest ten saved blocks range 5", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 9, toBlock: spectypes.LATEST_BLOCK - 4, specificBlock: spectypes.NOT_APPLICABLE, valid: true, expectedElements: 5},
		{name: "latest ten saved blocks range 5 the end of the list", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 4, toBlock: spectypes.LATEST_BLOCK, specificBlock: spectypes.LATEST_BLOCK, valid: true, expectedElements: 5},
		{name: "latest ten saved blocks range 5 overlap the end of the list", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 4, toBlock: spectypes.LATEST_BLOCK, specificBlock: spectypes.LATEST_BLOCK - 2, valid: true, expectedElements: 4},
		{name: "latest ten saved blocks range 5 overlap", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 5, toBlock: spectypes.LATEST_BLOCK, specificBlock: spectypes.LATEST_BLOCK - 2, valid: true, expectedElements: 5},
		{name: "latest ten saved blocks range 5 w specific next", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 9, toBlock: spectypes.LATEST_BLOCK - 4, specificBlock: spectypes.LATEST_BLOCK - 4, valid: true, expectedElements: 6},
		{name: "latest ten saved blocks range 5 w specific", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 9, toBlock: spectypes.LATEST_BLOCK - 4, specificBlock: spectypes.LATEST_BLOCK - 2, valid: true, expectedElements: 6},
		{name: "latest ten saved blocks range 5 w specific before", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 6, toBlock: spectypes.LATEST_BLOCK - 1, specificBlock: spectypes.LATEST_BLOCK - 8, valid: true, expectedElements: 6},
		{name: "latest ten saved blocks range 5 w specific prev", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 6, toBlock: spectypes.LATEST_BLOCK - 1, specificBlock: spectypes.LATEST_BLOCK - 7, valid: true, expectedElements: 6},
		{name: "latest ten saved blocks range 10", earliestBlock: 1000, latestBlock: 1009, fromBlock: spectypes.LATEST_BLOCK - 9, toBlock: spectypes.LATEST_BLOCK, specificBlock: spectypes.LATEST_BLOCK, valid: true, expectedElements: 10},
		...
		{name: "invalid only one saved block from/specific N/A", earliestBlock: 1000, latestBlock: 1000, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: spectypes.NOT_APPLICABLE, valid: false, expectedElements: 0},
		...
		{name: "invalid only one saved block invalid range size", earliestBlock: 1000, latestBlock: 1000, fromBlock: 1000, toBlock: 1000, specificBlock: spectypes.NOT_APPLICABLE, valid: false, expectedElements: 0},
		...
		{name: "invalid only one saved block invalid specific bigger", earliestBlock: 1000, latestBlock: 1000, fromBlock: 1000, toBlock: 1001, specificBlock: 1001, valid: false, expectedElements: 0},
		{name: "invalid only one saved block invalid specific smaller", earliestBlock: 1000, latestBlock: 1000, fromBlock: 1000, toBlock: 1001, specificBlock: 999, valid: false, expectedElements: 0},
		{name: "invalid only one saved block invalid specific bigger range N/A", earliestBlock: 1000, latestBlock: 1000, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: 1001, valid: false, expectedElements: 0},
		{name: "invalid only one saved block invalid specific smaller range N/A", earliestBlock: 1000, latestBlock: 1000, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: 999, valid: false, expectedElements: 0},
		...
		{name: "invalid latest only one saved block invalid specific smaller range N/A", earliestBlock: 1000, latestBlock: 1000, fromBlock: spectypes.NOT_APPLICABLE, toBlock: 1001, specificBlock: spectypes.LATEST_BLOCK - 1, valid: false, expectedElements: 0},

		{name: "invalid specific ten saved blocks range 5", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1005, specificBlock: 999, valid: false, expectedElements: 0},
		{name: "invalid specific ten saved blocks range 5 the end of the list", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1005, toBlock: 1010, specificBlock: 999, valid: false, expectedElements: 0},
		{name: "invalid specific ten saved blocks range 10", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1010, specificBlock: 999, valid: false, expectedElements: 0},
		{name: "invalid specific latest ten saved blocks range 5", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1005, specificBlock: spectypes.LATEST_BLOCK - 10, valid: false, expectedElements: 0},
		{name: "invalid specific latest ten saved blocks range 5 the end of the list", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1005, toBlock: 1010, specificBlock: spectypes.LATEST_BLOCK - 10, valid: false, expectedElements: 0},
		{name: "invalid specific latest ten saved blocks range 10", earliestBlock: 1000, latestBlock: 1009, fromBlock: 1000, toBlock: 1010, specificBlock: spectypes.LATEST_BLOCK - 10, valid: false, expectedElements: 0},

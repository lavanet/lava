...
//
//	mockgen -source=protocol/chainlib/chainlib.go -destination=protocol/chainlib/chainlib_mock.go -package chainlib
//
...
func (mr *MockChainParserMockRecorder) CraftMessage(parser, connectionType, craftData, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockChainParser) ExtractDataFromRequest(arg0 *http.Request) (string, string, string, []types.Metadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExtractDataFromRequest", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(string)
	ret3, _ := ret[3].([]types.Metadata)
	ret4, _ := ret[4].(error)
	return ret0, ret1, ret2, ret3, ret4
}

// ExtractDataFromRequest indicates an expected call of ExtractDataFromRequest.
func (mr *MockChainParserMockRecorder) ExtractDataFromRequest(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) GetParsingByTag(tag any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) GetVerifications(supported, internalPath, apiInterface any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) HandleHeaders(metadata, apiCollection, headersDirection any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) IsInternalPathEnabled(internalPath, apiInterface, addon any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockChainParser) IsTagInCollection(tag types0.FUNCTION_TAG, collectionKey CollectionKey) bool {
	m.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) IsTagInCollection(tag, collectionKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) ParseMsg(url, data, connectionType, metadata, extensionInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) SeparateAddonsExtensions(supported any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) SetPolicy(policy, chainId, apiInterface any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) SetResponseFromRelayResult(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) SetSpec(spec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainParserMockRecorder) UpdateBlockTime(newBlockTime any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) AppendHeader(metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) CheckResponseError(data, httpStatusCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) OverrideExtensions(extensionNames, extensionParser any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) SetExtension(extension any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) SetForceCacheRefresh(force any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) SubscriptionIdExtractor(reply any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) TimeoutOverride(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) UpdateEarliestInMessage(incomingEarliest any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainMessageMockRecorder) UpdateLatestBlockInMessage(latestBlock, modifyContent any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// CheckResponseError indicates an expected call of CheckResponseError.
func (mr *MockChainMessageForSendMockRecorder) CheckResponseError(data, httpStatusCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// TimeoutOverride indicates an expected call of TimeoutOverride.
func (mr *MockChainMessageForSendMockRecorder) TimeoutOverride(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRelaySenderMockRecorder) CancelSubscriptionContext(subscriptionKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRelaySenderMockRecorder) CreateDappKey(userData any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRelaySenderMockRecorder) ParseRelay(ctx, url, req, connectionType, dappID, consumerIp, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRelaySenderMockRecorder) SendParsedRelay(ctx, analytics, protocolMessage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRelaySenderMockRecorder) SendRelay(ctx, url, req, connectionType, dappID, consumerIp, analytics, metadataValues any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRelaySenderMockRecorder) SetConsistencySeenBlock(blockSeen, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainListenerMockRecorder) Serve(ctx, cmdFlags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainRouterMockRecorder) ExtensionsSupported(internalPath, extensions any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockChainRouter) SendNodeMsg(ctx context.Context, ch chan any, chainMessage ChainMessageForSend, extensions []string) (*RelayReplyWrapper, string, *rpcclient.ClientSubscription, common.NodeUrl, string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockChainRouterMockRecorder) SendNodeMsg(ctx, ch, chainMessage, extensions any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SendNodeMsg mocks base method.
func (m *MockChainProxy) SendNodeMsg(ctx context.Context, ch chan any, chainMessage ChainMessageForSend) (*RelayReplyWrapper, string, *rpcclient.ClientSubscription, error) {
	m.ctrl.T.Helper()
...
// SendNodeMsg indicates an expected call of SendNodeMsg.
func (mr *MockChainProxyMockRecorder) SendNodeMsg(ctx, ch, chainMessage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
//
//	mockgen -source=protocol/chainlib/chainlib.go -destination protocol/chainlib/relay_sender_mock.go -package chainlib
//
...
func (m *MockChainParser) GetParsingByTag(tag types0.FUNCTION_TAG) (*types0.ParseDirective, *types0.CollectionData, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetParsingByTag", tag)
	ret0, _ := ret[0].(*types0.ParseDirective)
	ret1, _ := ret[1].(*types0.CollectionData)
	ret2, _ := ret[2].(bool)
...
func (mr *MockChainParserMockRecorder) GetVerifications(supported any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRelaySenderMockRecorder) CreateDappKey(dappID, consumerIp any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRelaySender) ParseRelay(ctx context.Context, url, req, connectionType, dappID, consumerIp string, analytics *metrics.RelayMetrics, metadata []types.Metadata) (ChainMessage, map[string]string, *types.RelayPrivateData, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseRelay", ctx, url, req, connectionType, dappID, consumerIp, analytics, metadata)
	ret0, _ := ret[0].(ChainMessage)
	ret1, _ := ret[1].(map[string]string)
	ret2, _ := ret[2].(*types.RelayPrivateData)
	ret3, _ := ret[3].(error)
	return ret0, ret1, ret2, ret3
}

// ParseRelay indicates an expected call of ParseRelay.
func (mr *MockRelaySenderMockRecorder) ParseRelay(ctx, url, req, connectionType, dappID, consumerIp, analytics, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRelaySender) SendParsedRelay(ctx context.Context, dappID, consumerIp string, analytics *metrics.RelayMetrics, chainMessage ChainMessage, directiveHeaders map[string]string, relayRequestData *types.RelayPrivateData) (*common.RelayResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendParsedRelay", ctx, dappID, consumerIp, analytics, chainMessage, directiveHeaders, relayRequestData)
...
func (mr *MockRelaySenderMockRecorder) SendParsedRelay(ctx, dappID, consumerIp, analytics, chainMessage, directiveHeaders, relayRequestData any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendParsedRelay", reflect.TypeOf((*MockRelaySender)(nil).SendParsedRelay), ctx, dappID, consumerIp, analytics, chainMessage, directiveHeaders, relayRequestData)
}
...
func (mr *MockChainRouterMockRecorder) ExtensionsSupported(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

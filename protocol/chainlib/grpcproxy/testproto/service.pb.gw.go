...
var (
	filter_Test_Test_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_Test_Test_0(ctx context.Context, marshaler runtime.Marshaler, client TestClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Test_Test_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_Test_Test_0(ctx context.Context, marshaler runtime.Marshaler, server TestServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TestRequest
	var metadata runtime.ServerMetadata
...
func RegisterTestHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TestServer) error {
	...
	mux.Handle("GET", pattern_Test_Test_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Test_Test_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Test_Test_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTestHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TestClient) error {
	...
	mux.Handle("GET", pattern_Test_Test_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Test_Test_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Test_Test_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"test"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Test_Test_0 = runtime.ForwardResponseMessage
)

...
var (
	...
	LavaErrorSubscriptionAlreadyExists = registerError(&LavaError{
...
var (
	...
	LavaErrorChainStarknetTxVersionUnsupported = registerError(&LavaError{
	...
	LavaErrorChainBitcoinWalletInsufficientFunds = registerError(&LavaError{

...
var (
	...
	LavaErrorChainSolanaSlotSkipped = registerError(&LavaError{
		Code: 3301, Name: "CHAIN_SOLANA_SLOT_SKIPPED", Category: CategoryExternal,
		Description: "Solana slot was skipped (-32007)", Retryable: false,
	})

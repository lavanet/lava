...
const (
	...
	RelayHealthIntervalFlag = "relay-health-interval" // interval between each relay health check, default 5m
)
...
type ConsumerCmdFlags struct {
	...
	RelayHealthIntervalFlag string // interval for relay health check
}

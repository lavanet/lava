...
// transport is used for the message-based fallback when no sdkerrors code is found.
// Use this for protocol-layer errors from the lavasession/protocolerrors packages
// that carry an ABCI code via the sdkerrors interface.

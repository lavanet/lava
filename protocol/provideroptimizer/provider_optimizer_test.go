...
func TestProviderOptimizerBasic(t *testing.T) {
	...
	returnedProviders := providerOptimizer.ChooseProvider(providersGen.providersAddresses, nil, requestCU, requestBlock, pertrubationPercentage, uint64(requestBlock))
...
func TestProviderOptimizerAvailability(t *testing.T) {
	...
	returnedProviders = providerOptimizer.ChooseProvider(providersGen.providersAddresses, map[string]struct{}{providersGen.providersAddresses[skipIndex]: {}}, requestCU, requestBlock, pertrubationPercentage, uint64(requestBlock))
	require.Equal(t, 1, len(returnedProviders))
...
func TestProviderOptimizerAvailabilityBlockError(t *testing.T) {
	...
	returnedProviders = providerOptimizer.ChooseProvider(providersGen.providersAddresses, nil, requestCU, requestBlock-1, pertrubationPercentage, uint64(requestBlock))
	require.Equal(t, 1, len(returnedProviders))
...
func TestProviderOptimizerSyncScore(t *testing.T) {
	...
	returnedProviders = providerOptimizer.ChooseProvider(providersGen.providersAddresses, nil, requestCU, int64(syncBlock), pertrubationPercentage, uint64(requestBlock))
	require.Equal(t, 1, len(returnedProviders))
...
func TestProviderOptimizerStrategiesScoring(t *testing.T) {
	...
	returnedProviders = providerOptimizer.ChooseProvider(providersGen.providersAddresses, map[string]struct{}{providersGen.providersAddresses[2]: {}}, requestCU, requestBlock, pertrubationPercentage, uint64(requestBlock))
	require.Equal(t, 1, len(returnedProviders))
...
func TestProviderOptimizerPerturbation(t *testing.T) {
	...
	same := 0
	pickFaults := 0
	chosenProvider := providerOptimizer.ChooseProvider(providersGen.providersAddresses, nil, requestCU, requestBlock, 0, syncBlock)[0]
	runs := 1000
	// runs := 0
	for i := 0; i < runs; i++ {
		returnedProviders := providerOptimizer.ChooseProvider(providersGen.providersAddresses, nil, requestCU, requestBlock, pertrubationPercentage, syncBlock)
		require.Equal(t, 1, len(returnedProviders))

...
func NewRelayData(ctx context.Context, connectionType string, apiUrl string, data []byte, requestBlock int64, apiInterface string, metadataValues []pairingtypes.Metadata) *pairingtypes.RelayPrivateData {

...
var ( // Consumer Side Errors
	...
	InvalidReturnedHashes          = sdkerrors.New("Invalid value for requestedHashes length", 3, "returned requestedHashes key count should be greater than 0, but it's not")
)

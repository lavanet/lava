...
func (k Keeper) StakeNewEntry(ctx sdk.Context, creator, chainID string, amount sdk.Coin, endpoints []epochstoragetypes.Endpoint, geolocation uint64, moniker string, delegationLimit sdk.Coin, delegationCommission uint64) error {
	logger := k.Logger(ctx)

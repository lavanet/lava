...
type StakeToMaxCUList struct {
	List []*StakeToMaxCU `protobuf:"bytes,1,rep,name=List,proto3" json:"List,omitempty"`
}
...
type StakeToMaxCU struct {
	StakeThreshold  uint64 `protobuf:"varint,1,opt,name=StakeThreshold,proto3" json:"StakeThreshold,omitempty"`
...
func (m *StakeToMaxCU) GetStakeThreshold() uint64 {
	if m != nil {
...
var fileDescriptor_3371a34462f71f99 = []byte{
	...
	,
	...
	0xe7, 0xea, 0x43, 0xdd, 0x0b, 0xa6, 0xf5, 0x2b, 0xf4, 0x61, 0x61, 0x53, 0x52, 0x59, 0x90, 0x5a,
	0x9c, 0xc4, 0x06, 0x0e, 0x0d, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x5c, 0xb5, 0x2d, 0x58,
	0x33, 0x01, 0x00, 0x00,
}
...
func (m *StakeToMaxCU) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StakeThreshold != 0 {
		i = encodeVarintStakeToMaxCuList(dAtA, i, uint64(m.StakeThreshold))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *StakeToMaxCU) Size() (n int) {
	...
	_ = l
	if m.StakeThreshold != 0 {
		n += 1 + sovStakeToMaxCuList(uint64(m.StakeThreshold))
	}
	if m.MaxComputeUnits != 0 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StakeThreshold |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

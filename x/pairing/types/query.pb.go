...
import (
	...
	types5 "github.com/lavanet/lava/x/plans/types"
	types2 "github.com/lavanet/lava/x/projects/types"
	types6 "github.com/lavanet/lava/x/spec/types"
...
type QueryEffectivePolicyResponse struct {
	Policy        *types5.Policy `protobuf:"bytes,1,opt,name=policy,proto3" json:"policy,omitempty"`
	PendingPolicy *types5.Policy `protobuf:"bytes,2,opt,name=pending_policy,json=pendingPolicy,proto3" json:"pending_policy,omitempty"`
}
...
func (m *QueryEffectivePolicyResponse) GetPolicy() *types5.Policy {
	if m != nil {
		return m.Policy
	}
	return nil
...
func (m *QueryEffectivePolicyResponse) GetPendingPolicy() *types5.Policy {
	if m != nil {
...
type QuerySdkPairingResponse struct {
	...
	Spec    *types6.Spec             `protobuf:"bytes,3,opt,name=spec,proto3" json:"spec,omitempty"`
}
...
func (m *QuerySdkPairingResponse) GetSpec() *types6.Spec {
	if m != nil {
		return m.Spec
	}
	return nil
...
var fileDescriptor_9e149ce9d21da0d8 = []byte{
	...
	,
}

...
type QueryProvidersRequest struct {
	...
	ShowFrozenProviders bool   `protobuf:"varint,2,opt,name=showFrozenProviders,proto3" json:"showFrozenProviders,omitempty"`
}
...
func (m *QueryProvidersRequest) GetShowFrozenProviders() bool {
	if m != nil {
		return m.ShowFrozenProviders
	}
	return false
}
...
type QueryGetPairingResponse struct {
	...
	BlockOfNextPairing    uint64             `protobuf:"varint,5,opt,name=blockOfNextPairing,proto3" json:"blockOfNextPairing,omitempty"`
}
...
var fileDescriptor_6bd8a3cd41a2a1ee = []byte{
	...
	,
}
...
func (m *QueryProvidersRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShowFrozenProviders", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ShowFrozenProviders = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
			if err != nil {

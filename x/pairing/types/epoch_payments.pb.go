...
type EpochPayments struct {
	...
	ProviderPaymentStorages []*ProviderPaymentStorage `protobuf:"bytes,2,rep,name=providerPaymentStorages,proto3" json:"providerPaymentStorages,omitempty"`
}
...
func (m *EpochPayments) GetProviderPaymentStorages() []*ProviderPaymentStorage {
	if m != nil {
		return m.ProviderPaymentStorages
	}
	return nil
}
...
var fileDescriptor_747a4457843f82da = []byte{
	...
	,
}
...
func (m *EpochPayments) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ProviderPaymentStorages) > 0 {
		for iNdEx := len(m.ProviderPaymentStorages) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ProviderPaymentStorages[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *EpochPayments) Size() (n int) {
	...
	if len(m.ProviderPaymentStorages) > 0 {
		for _, e := range m.ProviderPaymentStorages {
			l = e.Size()
			n += 1 + l + sovEpochPayments(uint64(l))
		}
	}
...
func (m *EpochPayments) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProviderPaymentStorages", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProviderPaymentStorages = append(m.ProviderPaymentStorages, &ProviderPaymentStorage{})
			if err := m.ProviderPaymentStorages[len(m.ProviderPaymentStorages)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

...
// consumer in a specific epoch. It also tracks the QoS excellence of the provider and consumer
// in the epoch.
...
type ProviderConsumerEpochCu struct {
	...
	QosSum    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=qos_sum,json=qosSum,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"qos_sum"`
	QosAmount uint64                                 `protobuf:"varint,3,opt,name=qos_amount,json=qosAmount,proto3" json:"qos_amount,omitempty"`
}
...
func (m *ProviderConsumerEpochCu) GetQosAmount() uint64 {
	if m != nil {
		return m.QosAmount
	}
	return 0
...
var fileDescriptor_c2abb0ec984ffb4c = []byte{
	...
	,
}
...
func (m *ProviderConsumerEpochCu) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.QosAmount != 0 {
		i = encodeVarintEpochCu(dAtA, i, uint64(m.QosAmount))
		i--
		dAtA[i] = 0x18
	}
	{
		size := m.QosSum.Size()
		i -= size
		if _, err := m.QosSum.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintEpochCu(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x12
	if m.Cu != 0 {
...
func (m *ProviderConsumerEpochCu) Size() (n int) {
	...
	l = m.QosSum.Size()
	n += 1 + l + sovEpochCu(uint64(l))
	if m.QosAmount != 0 {
		n += 1 + sovEpochCu(uint64(m.QosAmount))
	}
	return n
}
...
func (m *ProviderConsumerEpochCu) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosSum", wireType)
			}
			...
			if err := m.QosSum.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QosAmount", wireType)
			}
			m.QosAmount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QosAmount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

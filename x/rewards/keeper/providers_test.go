...
func TestZeroProvidersRewards(t *testing.T) {
	...
	err := ts.StakeProvider(providerAcc.Addr.String(), providerAcc.Vault.Addr.String(), ts.specs[0], testBalance)
	...
	res, err := ts.QueryDualstakingDelegatorRewards(providerAcc.Vault.Addr.String(), providerAcc.Addr.String(), "")
	require.NoError(t, err)
...
func TestBasicBoostProvidersRewards(t *testing.T) {
	...
	_, err = ts.TxDualstakingClaimRewards(providerAcc.Vault.Addr.String(), providerAcc.Addr.String())
	require.NoError(t, err)
...
func Test2SpecsZeroShares(t *testing.T) {
	...
	err = ts.StakeProvider(providerAcc.Addr.String(), providerAcc.Vault.Addr.String(), spec2, testBalance)
	require.NoError(t, err)
	...
	_, err = ts.TxDualstakingClaimRewards(providerAcc.Vault.Addr.String(), "")
	require.NoError(t, err)
...
func TestBonusRewards3Providers(t *testing.T) {
	...
	err := ts.StakeProvider(providerAcc1.Addr.String(), providerAcc1.Vault.Addr.String(), ts.specs[0], testBalance)
	require.NoError(t, err)

	providerAcc2, _ := ts.AddAccount(common.PROVIDER, 2, 2*testBalance)
	err = ts.StakeProvider(providerAcc2.Addr.String(), providerAcc2.Vault.Addr.String(), ts.specs[0], 2*testBalance)
	require.NoError(t, err)

	providerAcc3, _ := ts.AddAccount(common.PROVIDER, 3, 3*testBalance)
	err = ts.StakeProvider(providerAcc3.Addr.String(), providerAcc3.Vault.Addr.String(), ts.specs[0], 3*testBalance)
	require.NoError(t, err)
	...
	res, err := ts.QueryDualstakingDelegatorRewards(providerAcc1.Vault.Addr.String(), "", "")
	require.NoError(t, err)
	require.Len(t, res.Rewards, 1)
	_, err = ts.TxDualstakingClaimRewards(providerAcc1.Vault.Addr.String(), "")
	require.NoError(t, err)

	res, err = ts.QueryDualstakingDelegatorRewards(providerAcc2.Vault.Addr.String(), "", "")
	require.NoError(t, err)
	require.Len(t, res.Rewards, 1)
	_, err = ts.TxDualstakingClaimRewards(providerAcc2.Vault.Addr.String(), "")
	require.NoError(t, err)

	res, err = ts.QueryDualstakingDelegatorRewards(providerAcc3.Vault.Addr.String(), "", "")
	require.NoError(t, err)
	require.Len(t, res.Rewards, 1)
	_, err = ts.TxDualstakingClaimRewards(providerAcc3.Vault.Addr.String(), "")
	require.NoError(t, err)
	...
	res1, err := ts.QueryDualstakingDelegatorRewards(providerAcc1.Vault.Addr.String(), "", "")
	require.NoError(t, err)
	require.Len(t, res.Rewards, 1)
	...
	_, err = ts.TxDualstakingClaimRewards(providerAcc1.Vault.Addr.String(), providerAcc1.Addr.String())
	require.NoError(t, err)

	res2, err := ts.QueryDualstakingDelegatorRewards(providerAcc2.Vault.Addr.String(), "", "")
	require.NoError(t, err)
	require.Len(t, res.Rewards, 1)
	...
	_, err = ts.TxDualstakingClaimRewards(providerAcc2.Vault.Addr.String(), providerAcc2.Addr.String())
	require.NoError(t, err)

	res3, err := ts.QueryDualstakingDelegatorRewards(providerAcc3.Vault.Addr.String(), "", "")
	require.NoError(t, err)
	require.Len(t, res.Rewards, 1)
	...
	_, err = ts.TxDualstakingClaimRewards(providerAcc3.Vault.Addr.String(), providerAcc3.Addr.String())
	require.NoError(t, err)
}
...
func TestBonusRewardsEquall5Providers(t *testing.T) {
	...
	for _, providerAcc := range providerAccs {
		res, err := ts.QueryDualstakingDelegatorRewards(providerAcc.Vault.Addr.String(), "", "")
		require.NoError(t, err)
		require.Len(t, res.Rewards, 1)
		_, err = ts.TxDualstakingClaimRewards(providerAcc.Vault.Addr.String(), "")
		require.NoError(t, err)

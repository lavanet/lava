...
type PolicySelectedProvidersMode int32

const (
	Policy_ALLOWED   PolicySelectedProvidersMode = 0
	Policy_MIXED     PolicySelectedProvidersMode = 1
	Policy_EXCLUSIVE PolicySelectedProvidersMode = 2
	Policy_DISABLED  PolicySelectedProvidersMode = 3
)

var PolicySelectedProvidersMode_name = map[int32]string{
	0: "ALLOWED",
	1: "MIXED",
	2: "EXCLUSIVE",
	3: "DISABLED",
...
var PolicySelectedProvidersMode_value = map[string]int32{
	"ALLOWED":   0,
	"MIXED":     1,
	"EXCLUSIVE": 2,
	"DISABLED":  3,
...
func (x PolicySelectedProvidersMode) String() string {
	return proto.EnumName(PolicySelectedProvidersMode_name, int32(x))
}

func (PolicySelectedProvidersMode) EnumDescriptor() ([]byte, []int) {
...
type Policy struct {
	...
	Mode               PolicySelectedProvidersMode `protobuf:"varint,6,opt,name=mode,proto3,enum=lavanet.lava.projects.PolicySelectedProvidersMode" json:"mode" mapstructure:"mode"`
...
func (m *Policy) GetMode() PolicySelectedProvidersMode {
	if m != nil {
		return m.Mode
	}
...
func init() {
	...
	proto.RegisterEnum("lavanet.lava.projects.PolicySelectedProvidersMode", PolicySelectedProvidersMode_name, PolicySelectedProvidersMode_value)
...
var fileDescriptor_9f89a31663a330ce = []byte{
	...
	,
}
...
func (m *Policy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Mode != 0 {
		i = encodeVarintProject(dAtA, i, uint64(m.Mode))
		i--
		dAtA[i] = 0x30
	}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Mode |= PolicySelectedProvidersMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

...
type ProjectKey struct {
	...
	Types []ProjectKey_KeyType `protobuf:"bytes,2,rep,name=types,proto3" json:"types"`
}
...
func (m *ProjectKey) GetTypes() []ProjectKey_KeyType {
	if m != nil {
		return m.Types
	}
	return nil
...
type ProjectKey_KeyType struct {
	KeyTypes ProjectKey_KEY_TYPE `protobuf:"varint,1,opt,name=key_types,json=keyTypes,proto3,enum=lavanet.lava.projects.ProjectKey_KEY_TYPE" json:"key_types,omitempty"`
}

func (m *ProjectKey_KeyType) Reset()         { *m = ProjectKey_KeyType{} }
func (m *ProjectKey_KeyType) String() string { return proto.CompactTextString(m) }
func (*ProjectKey_KeyType) ProtoMessage()    {}
func (*ProjectKey_KeyType) Descriptor() ([]byte, []int) {
	return fileDescriptor_9f89a31663a330ce, []int{1, 0}
}
func (m *ProjectKey_KeyType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProjectKey_KeyType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProjectKey_KeyType.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ProjectKey_KeyType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProjectKey_KeyType.Merge(m, src)
}
func (m *ProjectKey_KeyType) XXX_Size() int {
	return m.Size()
}
func (m *ProjectKey_KeyType) XXX_DiscardUnknown() {
	xxx_messageInfo_ProjectKey_KeyType.DiscardUnknown(m)
}

var xxx_messageInfo_ProjectKey_KeyType proto.InternalMessageInfo

func (m *ProjectKey_KeyType) GetKeyTypes() ProjectKey_KEY_TYPE {
	if m != nil {
		return m.KeyTypes
	}
	return ProjectKey_NONE
}
...
func init() {
	...
	proto.RegisterType((*ProjectKey_KeyType)(nil), "lavanet.lava.projects.ProjectKey.KeyType")
...
var fileDescriptor_9f89a31663a330ce = []byte{
	...
	,
}
...
func (this *ProjectKey_KeyType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ProjectKey_KeyType)
	if !ok {
		that2, ok := that.(ProjectKey_KeyType)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.KeyTypes != that1.KeyTypes {
		return false
	}
	return true
}
...
func (m *ProjectKey_KeyType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ProjectKey_KeyType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProjectKey_KeyType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.KeyTypes != 0 {
		i = encodeVarintProject(dAtA, i, uint64(m.KeyTypes))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ProjectKey_KeyType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.KeyTypes != 0 {
		n += 1 + sovProject(uint64(m.KeyTypes))
	}
	return n
}
...
func (m *ProjectKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Types = append(m.Types, ProjectKey_KeyType{})
...
func (m *ProjectKey_KeyType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KeyTypes |= ProjectKey_KEY_TYPE(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

...
type PolicySelectedProvidersModeEnum int32

const (
	Policy_ALLOWED   PolicySelectedProvidersModeEnum = 0
	Policy_MIXED     PolicySelectedProvidersModeEnum = 1
	Policy_EXCLUSIVE PolicySelectedProvidersModeEnum = 2
	Policy_DISABLED  PolicySelectedProvidersModeEnum = 3
)

var PolicySelectedProvidersModeEnum_name = map[int32]string{
	0: "ALLOWED",
	1: "MIXED",
	2: "EXCLUSIVE",
	3: "DISABLED",
...
var PolicySelectedProvidersModeEnum_value = map[string]int32{
	"ALLOWED":   0,
	"MIXED":     1,
	"EXCLUSIVE": 2,
	"DISABLED":  3,
...
func (x PolicySelectedProvidersModeEnum) String() string {
	return proto.EnumName(PolicySelectedProvidersModeEnum_name, int32(x))
}

func (PolicySelectedProvidersModeEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9f89a31663a330ce, []int{2, 0}
}
...
type Policy struct {
	...
	SelectedProvidersMode PolicySelectedProvidersModeEnum `protobuf:"varint,6,opt,name=selected_providers_mode,json=selectedProvidersMode,proto3,enum=lavanet.lava.projects.PolicySelectedProvidersModeEnum" json:"selected_providers_mode" mapstructure:"selected_providers_mode"`
...
func (m *Policy) GetSelectedProvidersMode() PolicySelectedProvidersModeEnum {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("lavanet.lava.projects.PolicySelectedProvidersModeEnum", PolicySelectedProvidersModeEnum_name, PolicySelectedProvidersModeEnum_value)
...
var fileDescriptor_9f89a31663a330ce = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SelectedProvidersMode |= PolicySelectedProvidersModeEnum(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

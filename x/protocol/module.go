...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	if err := cfg.RegisterMigration(types.ModuleName, 27, migrator.MigrateVersion); err != nil {
		// panic:ok: at start up, migration cannot proceed anyhow
		panic(fmt.Errorf("%s: failed to register migration to v28: %w", types.ModuleName, err))
	}
}

// ConsensusVersion implements ConsensusVersion.
func (AppModule) ConsensusVersion() uint64 { return 28 }

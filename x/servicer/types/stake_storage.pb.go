...
type StakeStorage struct {
	...
	Unstaking []StakeMap `protobuf:"bytes,2,rep,name=unstaking,proto3" json:"unstaking"`
}
...
func (m *StakeStorage) GetUnstaking() []StakeMap {
	if m != nil {
		return m.Unstaking
	}
	return nil
...
var fileDescriptor_568e849a6a7c50ef = []byte{
	...
	,
}
...
func (m *StakeStorage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Unstaking) > 0 {
		for iNdEx := len(m.Unstaking) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Unstaking[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *StakeStorage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Unstaking = append(m.Unstaking, StakeMap{})
			if err := m.Unstaking[len(m.Unstaking)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

...
type ParseDirective struct {
	...
	ExpectedResult   string       `protobuf:"bytes,5,opt,name=expected_result,json=expectedResult,proto3" json:"expected_result,omitempty"`
}
...
func (m *ParseDirective) GetExpectedResult() string {
	if m != nil {
...
var fileDescriptor_f507d911e4171408 = []byte{
	...
	,
}
...
func (this *ParseDirective) Equal(that interface{}) bool {
	...
	if this.ExpectedResult != that1.ExpectedResult {
		return false
	}
	return true
}
...
func (m *ParseDirective) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ExpectedResult) > 0 {
		i -= len(m.ExpectedResult)
		copy(dAtA[i:], m.ExpectedResult)
		i = encodeVarintApiCollection(dAtA, i, uint64(len(m.ExpectedResult)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ApiName) > 0 {
...
func (m *ParseDirective) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpectedResult", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExpectedResult = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApiCollection(dAtA[iNdEx:])

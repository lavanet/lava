...
type ParseDirective struct {
	...
	WantedResult     string       `protobuf:"bytes,5,opt,name=wanted_result,json=wantedResult,proto3" json:"wanted_result,omitempty"`
}
...
func (m *ParseDirective) GetWantedResult() string {
	if m != nil {
		return m.WantedResult
	}
	return ""
}
...
var fileDescriptor_f507d911e4171408 = []byte{
	...
	,
}
...
func (this *ParseDirective) Equal(that interface{}) bool {
	...
	if this.WantedResult != that1.WantedResult {
		return false
	}
	return true
}
...
func (m *ParseDirective) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.WantedResult) > 0 {
		i -= len(m.WantedResult)
		copy(dAtA[i:], m.WantedResult)
		i = encodeVarintApiCollection(dAtA, i, uint64(len(m.WantedResult)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ApiName) > 0 {
...
func (m *ParseDirective) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WantedResult", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WantedResult = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApiCollection(dAtA[iNdEx:])

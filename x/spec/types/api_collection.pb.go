...
type Verification_VerificationSeverity int32

const (
	Verification_Fail    Verification_VerificationSeverity = 0
	Verification_Warning Verification_VerificationSeverity = 1
)

var Verification_VerificationSeverity_name = map[int32]string{
	0: "Fail",
	1: "Warning",
}

var Verification_VerificationSeverity_value = map[string]int32{
	"Fail":    0,
	"Warning": 1,
}

func (x Verification_VerificationSeverity) String() string {
	return proto.EnumName(Verification_VerificationSeverity_name, int32(x))
}

func (Verification_VerificationSeverity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c9f7567a181f534f, []int{3, 0}
}
...
type Verification struct {
	...
	Severity       Verification_VerificationSeverity `protobuf:"varint,4,opt,name=severity,proto3,enum=lavanet.lava.spec.Verification_VerificationSeverity" json:"severity,omitempty"`
}
...
func (m *Verification) GetSeverity() Verification_VerificationSeverity {
	if m != nil {
		return m.Severity
	}
...
func init() {
	...
	proto.RegisterEnum("lavanet.lava.spec.Verification_VerificationSeverity", Verification_VerificationSeverity_name, Verification_VerificationSeverity_value)
...
var fileDescriptor_c9f7567a181f534f = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Severity |= Verification_VerificationSeverity(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

...
type Spec struct {
	...
	AverageBlockTime     int64        `protobuf:"varint,7,opt,name=averageBlockTime,proto3" json:"averageBlockTime,omitempty"`
	BlochHeightThreshold int64        `protobuf:"varint,8,opt,name=blochHeightThreshold,proto3" json:"blochHeightThreshold,omitempty"`
}

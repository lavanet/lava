...
type Spec struct {
	...
	Apis   *ServiceApi `protobuf:"bytes,3,opt,name=apis,proto3" json:"apis,omitempty"`
...
var fileDescriptor_c4cc771ffab81d0a = []byte{
	...
	0x0b, 0x19, 0x72, 0xb1, 0x24, 0x16, 0x64, 0x16, 0x4b, 0x30, 0x2b, 0x30, 0x6a, 0x70, 0x1b, 0xc9,
	...
	0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0xd7, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x41,
	0xcb, 0x14, 0x65, 0xfb, 0x00, 0x00, 0x00,
}
...
func (m *Spec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Apis != nil {
		{
			size, err := m.Apis.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Spec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.Apis.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:

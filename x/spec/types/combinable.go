...
func CombineFields[T Combinable](currentMap map[string]interface{}, mergedMap map[string]interface{}, combineFrom []T, toCombine []T, allowOverwrite bool) ([]T, map[string]interface{}, error) {

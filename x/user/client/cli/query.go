...
func GetQueryCmd(queryRoute string) *cobra.Command {
	...
	cmd.AddCommand(CmdListUserStake())
	cmd.AddCommand(CmdShowUserStake())
	...
	cmd.AddCommand(CmdListUnstakingUsersAllSpecs())
	cmd.AddCommand(CmdShowUnstakingUsersAllSpecs())
	cmd.AddCommand(CmdStakedUsers())

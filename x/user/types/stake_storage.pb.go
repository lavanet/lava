...
type StakeStorage struct {
	StakedUsers UserStake `protobuf:"bytes,1,opt,name=stakedUsers,proto3" json:"stakedUsers"`
}
...
var fileDescriptor_67a553e13cbfdb8d = []byte{
	...
	0x25, 0x18, 0x15, 0x18, 0x35, 0xb8, 0x8d, 0x64, 0xf4, 0x30, 0x6c, 0xd1, 0x03, 0xc9, 0x83, 0x75,
	...
	0x93, 0xd8, 0xc0, 0x8e, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xee, 0xb8, 0xef, 0x9f, 0xf8,
	0x00, 0x00, 0x00,
}
...
func (m *StakeStorage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.StakedUsers.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *StakeStorage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.StakedUsers.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

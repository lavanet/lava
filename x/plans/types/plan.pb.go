...
import (
	...
	types1 "github.com/lavanet/lava/x/projects/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type Plan struct {
	...
	PlanPolicy               types1.Policy `protobuf:"bytes,14,opt,name=plan_policy,json=planPolicy,proto3" json:"plan_policy"`
}
...
func (m *Plan) GetPlanPolicy() types1.Policy {
	if m != nil {
		return m.PlanPolicy
	}
	return types1.Policy{}
}

...
type QueryGeolocationsRequest struct {
}

func (m *QueryGeolocationsRequest) Reset()         { *m = QueryGeolocationsRequest{} }
func (m *QueryGeolocationsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGeolocationsRequest) ProtoMessage()    {}
func (*QueryGeolocationsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_076d0f778fb40d3e, []int{7}
}
func (m *QueryGeolocationsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGeolocationsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGeolocationsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGeolocationsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGeolocationsRequest.Merge(m, src)
}
func (m *QueryGeolocationsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGeolocationsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGeolocationsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGeolocationsRequest proto.InternalMessageInfo

type QueryGeolocationsResponse struct {
	Geos []string `protobuf:"bytes,1,rep,name=geos,proto3" json:"geos,omitempty"`
}

func (m *QueryGeolocationsResponse) Reset()         { *m = QueryGeolocationsResponse{} }
func (m *QueryGeolocationsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGeolocationsResponse) ProtoMessage()    {}
func (*QueryGeolocationsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_076d0f778fb40d3e, []int{8}
}
func (m *QueryGeolocationsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGeolocationsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGeolocationsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGeolocationsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGeolocationsResponse.Merge(m, src)
}
func (m *QueryGeolocationsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGeolocationsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGeolocationsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGeolocationsResponse proto.InternalMessageInfo

func (m *QueryGeolocationsResponse) GetGeos() []string {
	if m != nil {
		return m.Geos
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryGeolocationsRequest)(nil), "lavanet.lava.plans.QueryGeolocationsRequest")
	proto.RegisterType((*QueryGeolocationsResponse)(nil), "lavanet.lava.plans.QueryGeolocationsResponse")
}
...
var fileDescriptor_076d0f778fb40d3e = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// Queries a list of Geolocations items.
	Geolocations(ctx context.Context, in *QueryGeolocationsRequest, opts ...grpc.CallOption) (*QueryGeolocationsResponse, error)
}
...
func (c *queryClient) Geolocations(ctx context.Context, in *QueryGeolocationsRequest, opts ...grpc.CallOption) (*QueryGeolocationsResponse, error) {
	out := new(QueryGeolocationsResponse)
	err := c.cc.Invoke(ctx, "/lavanet.lava.plans.Query/Geolocations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// Queries a list of Geolocations items.
	Geolocations(context.Context, *QueryGeolocationsRequest) (*QueryGeolocationsResponse, error)
}
...
func (*UnimplementedQueryServer) Geolocations(ctx context.Context, req *QueryGeolocationsRequest) (*QueryGeolocationsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Geolocations not implemented")
}
...
func _Query_Geolocations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryGeolocationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).Geolocations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lavanet.lava.plans.Query/Geolocations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).Geolocations(ctx, req.(*QueryGeolocationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Geolocations",
			Handler:    _Query_Geolocations_Handler,
		},
	},
...
func (m *QueryGeolocationsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGeolocationsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGeolocationsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGeolocationsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGeolocationsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGeolocationsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Geos) > 0 {
		for iNdEx := len(m.Geos) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Geos[iNdEx])
			copy(dAtA[i:], m.Geos[iNdEx])
			i = encodeVarintQuery(dAtA, i, uint64(len(m.Geos[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *QueryGeolocationsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGeolocationsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGeolocationsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGeolocationsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGeolocationsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryGeolocationsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGeolocationsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGeolocationsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Geos", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Geos = append(m.Geos, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])

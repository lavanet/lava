...
type EpochDetails struct {
	...
	AverageBlockTime uint64   `protobuf:"varint,4,opt,name=averageBlockTime,proto3" json:"averageBlockTime,omitempty"`
}
...
func (m *EpochDetails) GetAverageBlockTime() uint64 {
	if m != nil {
...
var fileDescriptor_bb65c9fbf477bc6d = []byte{
	...
	,
}
...
func (m *EpochDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AverageBlockTime != 0 {
		i = encodeVarintEpochDetails(dAtA, i, uint64(m.AverageBlockTime))
		i--
		dAtA[i] = 0x20
	}
...
func (m *EpochDetails) Size() (n int) {
	...
	if m.AverageBlockTime != 0 {
		n += 1 + sovEpochDetails(uint64(m.AverageBlockTime))
	}
	return n
}

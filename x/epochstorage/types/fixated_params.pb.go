...
type FixatedParams struct {
	...
	Parameters    Params `protobuf:"bytes,2,opt,name=parameters,proto3" json:"parameters"`
...
func (m *FixatedParams) GetParameters() Params {
	if m != nil {
		return m.Parameters
	}
	return Params{}
...
var fileDescriptor_899e892bbf90433a = []byte{
	...
	,
}
...
func (m *FixatedParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	}
	{
		...
		i -= size
		i = encodeVarintFixatedParams(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x12
	if len(m.Index) > 0 {

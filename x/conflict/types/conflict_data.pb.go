...
type FinalizationConflict struct {
	RelayFinalization0 *RelayFinalization `protobuf:"bytes,1,opt,name=relayFinalization0,proto3" json:"relayFinalization0,omitempty"`
	RelayFinalization1 *RelayFinalization `protobuf:"bytes,2,opt,name=relayFinalization1,proto3" json:"relayFinalization1,omitempty"`
}
...
func (m *FinalizationConflict) GetRelayFinalization0() *RelayFinalization {
	if m != nil {
		return m.RelayFinalization0
	}
	return nil
}

func (m *FinalizationConflict) GetRelayFinalization1() *RelayFinalization {
	if m != nil {
		return m.RelayFinalization1
	}
	return nil
}
...
var fileDescriptor_db493e54bcd78171 = []byte{
	...
	,
}
...
func (m *FinalizationConflict) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.RelayFinalization1 != nil {
		{
			size, err := m.RelayFinalization1.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RelayFinalization0 != nil {
		{
			size, err := m.RelayFinalization0.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *FinalizationConflict) Size() (n int) {
	...
	_ = l
	if m.RelayFinalization0 != nil {
		l = m.RelayFinalization0.Size()
		n += 1 + l + sovConflictData(uint64(l))
	}
	if m.RelayFinalization1 != nil {
		l = m.RelayFinalization1.Size()
		n += 1 + l + sovConflictData(uint64(l))
	}
	return n
}
...
func (m *FinalizationConflict) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RelayFinalization0", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RelayFinalization0 == nil {
				m.RelayFinalization0 = &RelayFinalization{}
			}
			if err := m.RelayFinalization0.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RelayFinalization1", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RelayFinalization1 == nil {
				m.RelayFinalization1 = &RelayFinalization{}
			}
			if err := m.RelayFinalization1.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

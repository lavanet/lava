...
type MsgDetection struct {
	...
	//	*MsgDetection_SameProviderConflict
...
type MsgDetection_SameProviderConflict struct {
	SameProviderConflict *FinalizationConflict `protobuf:"bytes,7,opt,name=same_provider_conflict,json=sameProviderConflict,proto3,oneof" json:"same_provider_conflict,omitempty"`
}

func (*MsgDetection_FinalizationConflict) isMsgDetection_Conflict() {}
func (*MsgDetection_ResponseConflict) isMsgDetection_Conflict()     {}
func (*MsgDetection_SameProviderConflict) isMsgDetection_Conflict() {}
...
func (m *MsgDetection) GetSameProviderConflict() *FinalizationConflict {
	if x, ok := m.GetConflict().(*MsgDetection_SameProviderConflict); ok {
		return x.SameProviderConflict
	}
	return nil
}
...
func (*MsgDetection) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*MsgDetection_SameProviderConflict)(nil),
	}
}
...
var fileDescriptor_8d098f1e58e895a1 = []byte{
	...
	,
}
...
func (m *MsgDetection_SameProviderConflict) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgDetection_SameProviderConflict) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MsgDetection_SameProviderConflict) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgDetection) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.Conflict = &MsgDetection_SameProviderConflict{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex

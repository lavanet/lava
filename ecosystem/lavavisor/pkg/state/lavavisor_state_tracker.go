...
func NewLavaVisorStateTracker(ctx context.Context, txFactory tx.Factory, clientCtx client.Context, chainFetcher chainlib.IChainFetcher) (lvst *LavaVisorStateTracker, err error) {
	// validate chainId

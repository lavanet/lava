...
exports.Commit = {
    ...
    fromJSON(object) {
        return {
            ...
            round: isSet(object.round) ? Number(object.round) : 0,
            blockId: isSet(object.blockId) ? exports.BlockID.fromJSON(object.blockId) : undefined,
            signatures: Array.isArray(object === null || object === void 0 ? void 0 : object.signatures) ? object.signatures.map((e) => exports.CommitSig.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.BlockMeta = {
    ...
    fromPartial(object) {
        ...
        message.numTxs = (object.numTxs !== undefined && object.numTxs !== null)
            ? long_1.default.fromValue(object.numTxs)
            : long_1.default.ZERO;
        return message;
    },
};

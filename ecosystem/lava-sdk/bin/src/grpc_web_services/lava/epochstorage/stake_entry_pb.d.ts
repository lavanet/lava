...
import * as lava_epochstorage_endpoint_pb from "../../lava/epochstorage/endpoint_pb";
...
export class StakeEntry extends jspb.Message {
  ...
  getEndpointsList(): Array<lava_epochstorage_endpoint_pb.Endpoint>;
  setEndpointsList(value: Array<lava_epochstorage_endpoint_pb.Endpoint>): void;
  addEndpoints(value?: lava_epochstorage_endpoint_pb.Endpoint, index?: number): lava_epochstorage_endpoint_pb.Endpoint;
...
export namespace StakeEntry {
  export type AsObject = {
    ...
    endpointsList: Array<lava_epochstorage_endpoint_pb.Endpoint.AsObject>,
    geolocation: number,
    chain: string,
    moniker: string,
  }

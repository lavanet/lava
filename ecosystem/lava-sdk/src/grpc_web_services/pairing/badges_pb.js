...
var pairing_relay_pb = require('../pairing/relay_pb.js');
goog.object.extend(proto, pairing_relay_pb);
...
proto.lavanet.lava.pairing.GenerateBadgeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    badge: (f = msg.getBadge()) && pairing_relay_pb.Badge.toObject(includeInstance, f),
...
proto.lavanet.lava.pairing.GenerateBadgeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new pairing_relay_pb.Badge;
      reader.readMessage(value,pairing_relay_pb.Badge.deserializeBinaryFromReader);
      msg.setBadge(value);
      break;
    case 2:
...
proto.lavanet.lava.pairing.GenerateBadgeResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      pairing_relay_pb.Badge.serializeBinaryToWriter
    );
  }
...
proto.lavanet.lava.pairing.GenerateBadgeResponse.prototype.getBadge = function() {
  return /** @type{?proto.lavanet.lava.pairing.Badge} */ (
    jspb.Message.getWrapperField(this, pairing_relay_pb.Badge, 1));
};

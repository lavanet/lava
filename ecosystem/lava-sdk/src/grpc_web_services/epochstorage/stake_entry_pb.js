...
var epochstorage_endpoint_pb = require('../epochstorage/endpoint_pb.js');
goog.object.extend(proto, epochstorage_endpoint_pb);
...
proto.lavanet.lava.epochstorage.StakeEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    epochstorage_endpoint_pb.Endpoint.toObject, includeInstance),
...
proto.lavanet.lava.epochstorage.StakeEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new epochstorage_endpoint_pb.Endpoint;
      reader.readMessage(value,epochstorage_endpoint_pb.Endpoint.deserializeBinaryFromReader);
...
proto.lavanet.lava.epochstorage.StakeEntry.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      epochstorage_endpoint_pb.Endpoint.serializeBinaryToWriter
    );
  }
...
proto.lavanet.lava.epochstorage.StakeEntry.prototype.getEndpointsList = function() {
  return /** @type{!Array<!proto.lavanet.lava.epochstorage.Endpoint>} */ (
    jspb.Message.getRepeatedWrapperField(this, epochstorage_endpoint_pb.Endpoint, 4));
};

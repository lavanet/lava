...
proto.lavanet.lava.spec.Spec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    dataReliabilityEnabled: jspb.Message.getBooleanFieldWithDefault(msg, 6, false),
    ...
    importsList: (f = jspb.Message.getRepeatedField(msg, 15)) == null ? undefined : f,
...
/**
 * @param {string} value
 * @return {!proto.lavanet.lava.spec.Spec} returns this
 */
...
proto.lavanet.lava.spec.Spec.prototype.clearMinStakeProvider = function() {
  return this.setMinStakeProvider(undefined);
};
...
proto.lavanet.lava.spec.Spec.prototype.clearMinStakeClient = function() {
  return this.setMinStakeClient(undefined);
};
...
proto.lavanet.lava.spec.Spec.prototype.clearApiCollectionsList = function() {
  return this.setApiCollectionsList([]);
};

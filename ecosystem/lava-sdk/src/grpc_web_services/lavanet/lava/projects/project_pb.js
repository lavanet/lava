...
/**
 * @param {string} value
 * @return {!proto.lavanet.lava.projects.Project} returns this
 */
...
proto.lavanet.lava.projects.Project.prototype.clearProjectKeysList = function() {
  return this.setProjectKeysList([]);
};
...
proto.lavanet.lava.projects.Project.prototype.clearAdminPolicy = function() {
  return this.setAdminPolicy(undefined);
};
...
proto.lavanet.lava.projects.Project.prototype.clearSubscriptionPolicy = function() {
  return this.setSubscriptionPolicy(undefined);
};
...
/**
 * @param {string} value
 * @return {!proto.lavanet.lava.projects.ProjectKey} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.lavanet.lava.projects.ProtoDeveloperData} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.lavanet.lava.projects.ProjectData} returns this
 */

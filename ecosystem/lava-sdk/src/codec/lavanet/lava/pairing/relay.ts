...
export const RelaySession = {
  ...
  fromJSON(object: any): RelaySession {
    return {
      ...
      unresponsiveProviders: Array.isArray(object?.unresponsiveProviders)
        ? object.unresponsiveProviders.map((e: any) => ReportedProvider.fromJSON(e))
        : [],
...
function createBaseReportedProvider(): ReportedProvider {
  return { address: "", disconnections: Long.UZERO, errors: Long.UZERO, timestampS: Long.ZERO };
}

export const ReportedProvider = {
  encode(message: ReportedProvider, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (!message.disconnections.isZero()) {
      writer.uint32(16).uint64(message.disconnections);
    }
    if (!message.errors.isZero()) {
      writer.uint32(24).uint64(message.errors);
    }
    if (!message.timestampS.isZero()) {
      writer.uint32(32).int64(message.timestampS);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ReportedProvider {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.disconnections = reader.uint64() as Long;
          continue;
        case 3:
          if (tag != 24) {
            break;
          ...
          message.errors = reader.uint64() as Long;
          continue;
        case 4:
          if (tag != 32) {
            break;
          ...
          message.timestampS = reader.int64() as Long;
          continue;
      }
      if ((tag & 7) == 4 || tag == 0) {
        break;
  ...
  fromJSON(object: any): ReportedProvider {
    return {
      address: isSet(object.address) ? String(object.address) : "",
      disconnections: isSet(object.disconnections) ? Long.fromValue(object.disconnections) : Long.UZERO,
      errors: isSet(object.errors) ? Long.fromValue(object.errors) : Long.UZERO,
      timestampS: isSet(object.timestampS) ? Long.fromValue(object.timestampS) : Long.ZERO,
    };
  },

  toJSON(message: ReportedProvider): unknown {
    const obj: any = {};
    message.address !== undefined && (obj.address = message.address);
    message.disconnections !== undefined && (obj.disconnections = (message.disconnections || Long.UZERO).toString());
    message.errors !== undefined && (obj.errors = (message.errors || Long.UZERO).toString());
    message.timestampS !== undefined && (obj.timestampS = (message.timestampS || Long.ZERO).toString());
    return obj;
  },

  create<I extends Exact<DeepPartial<ReportedProvider>, I>>(base?: I): ReportedProvider {
    return ReportedProvider.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<ReportedProvider>, I>>(object: I): ReportedProvider {
    const message = createBaseReportedProvider();
    message.address = object.address ?? "";
    message.disconnections = (object.disconnections !== undefined && object.disconnections !== null)
      ? Long.fromValue(object.disconnections)
      : Long.UZERO;
    message.errors = (object.errors !== undefined && object.errors !== null)
      ? Long.fromValue(object.errors)
      : Long.UZERO;
    message.timestampS = (object.timestampS !== undefined && object.timestampS !== null)
      ? Long.fromValue(object.timestampS)
      : Long.ZERO;
    return message;
  },
};

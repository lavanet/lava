...
// FormatterForRelayRequestAndResponseJsonRPC returns formatters that strip and restore
// the JSON-RPC "id" field, enabling cache hits across requests that differ only by id.

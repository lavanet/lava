...
sleep 20
lavad tx servicer stake-servicer "Ethereum Mainnet" 2000stake 0 "127.0.0.1:2221" -y --from servicer1
lavad tx servicer stake-servicer "Ethereum Mainnet" 2000stake 0 "127.0.0.1:2222" -y --from servicer2
lavad tx servicer stake-servicer "Ethereum Mainnet" 2000stake 0 "127.0.0.1:2223" -y --from servicer3
